public class CheckOutSystemApp{
	...
	public static void displayQuestions(String customersName, Scanner input, ArrayList<String> products, ArrayList<Integer> numberOfItems, ArrayList<Double> priceOfItems ){
