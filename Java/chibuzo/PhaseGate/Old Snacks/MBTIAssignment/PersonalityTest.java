...
public class PersonalityTest{
	...
	System.out.println(arrayOne[0]+arrayOne[1]);
	...
	System.out.println(arrayFive[0]+arrayFive[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		extraCounter = extraCounter + 1;
	else if (userAnswer.equals("B"))
	...
	System.out.println(arrayNine[0]+arrayNine[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		extraCounter = extraCounter + 1;
	else if (userAnswer.equals("B"))
	...
	System.out.println(arrayThirteen[0]+arrayThirteen[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		extraCounter = extraCounter + 1;
	else if (userAnswer.equals("B"))
	...
	System.out.println(arraySeventeen[0]+arraySeventeen[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		extraCounter = extraCounter + 1;
	else if (userAnswer.equals("B"))
	...
	if (extraCounter > introCounter)
		System.out.println("You selected "+extraCounter+" As and "+introCounter+" Bs. You are an extrovert.");
	else
		System.out.println("You selected "+introCounter+" Bs and "+extraCounter+" As. You are an introvert.");

	System.out.println(arrayTwo[0]+arrayTwo[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
	...
	System.out.println(arraySix[0]+arraySix[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		sensingCounter = sensingCounter + 1;
	else if (userAnswer.equals("B"))
	...
	System.out.println(arrayTen[0]+arrayTen[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		sensingCounter = sensingCounter + 1;
	else if (userAnswer.equals("B"))
	...
	System.out.println(arrayFourteen[0]+arrayFourteen[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		sensingCounter = sensingCounter + 1;
	else if (userAnswer.equals("B"))
	...
	System.out.println(arrayEighteen[0]+arrayEighteen[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		sensingCounter = sensingCounter + 1;
	else if (userAnswer.equals("B"))
	...
	if (sensingCounter > intuitiveCounter)
		System.out.println("You selected "+sensingCounter+" As and "+intuitiveCounter+" Bs. You are a sensing person.");
	else
		System.out.println("You selected "+intuitiveCounter+" Bs and "+sensingCounter+" As. You are intuitive.");

	System.out.println(arrayThree[0]+arrayThree[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
	...
	System.out.println(arraySeven[0]+arraySeven[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		thinkingCounter = thinkingCounter + 1;
	else if (userAnswer.equals("B"))
	...
	System.out.println(arrayEleven[0]+arrayEleven[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		thinkingCounter = thinkingCounter + 1;
	else if (userAnswer.equals("B"))
	...
	System.out.println(arrayFifteen[0]+arrayFifteen[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		thinkingCounter = thinkingCounter + 1;
	else if (userAnswer.equals("B"))
	...
	System.out.println(arrayNineteen[0]+arrayNineteen[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		thinkingCounter = thinkingCounter + 1;
	else if (userAnswer.equals("B"))
	...
	if (thinkingCounter > feelingCounter)
		System.out.println("You selected "+thinkingCounter+" As and "+feelingCounter+" Bs. You are a thinker.");
	else
		System.out.println("You selected "+feelingCounter+" Bs and "+thinkingCounter+" As. You are a feeling person.");


	System.out.println(arrayFour[0]+arrayFour[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
	...
	System.out.println(arrayEight[0]+arrayEight[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		judgingCounter = judgingCounter + 1;
	else if (userAnswer.equals("B"))
	...
	System.out.println(arrayTwelve[0]+arrayTwelve[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		judgingCounter = judgingCounter + 1;
	else if (userAnswer.equals("B"))
	...
	System.out.println(arraySixteen[0]+arraySixteen[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		judgingCounter = judgingCounter + 1;
	else if (userAnswer.equals("B"))
	...
	System.out.println(arrayTwenty[0]+arrayTwenty[1]);
	userAnswer = input.nextLine();
	if (userAnswer.equals("A"))
		judgingCounter = judgingCounter + 1;
	else if (userAnswer.equals("B"))
	...
	if (judgingCounter > perceptiveCounter)
		System.out.println("You selected "+judgingCounter+" As and "+perceptiveCounter+" Bs. You are a judging person.");
	else
		System.out.println("You selected "+perceptiveCounter+" Bs and "+judgingCounter+" As. You are perceptive."); 
